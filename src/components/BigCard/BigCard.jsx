...
function BigCard() {
    return (
        <ScrollAnimation animateIn="zoomIn" animateOut="fadeOut" className={styles.cardContainer}>
            ...
            <div className={styles.bigCard}>
                ...
                <ScrollAnimation animateIn="fadeInRight" animateOut="fadeOut" className={styles.description}>
