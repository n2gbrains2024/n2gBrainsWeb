...
function LandingComponent(){
    return (
        ...
        <ScrollAnimation animateIn="zoomInUp" animateOut="zoomOut" className={styles.videoContainer}>
            <video className={styles.player} src='videos/video.mp4' controls />
        </ScrollAnimation>
        <ScrollAnimation animateIn="backInUp" animateOut="backOutUp" className={styles.texts}>
