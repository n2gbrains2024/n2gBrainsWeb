...
function Feedbacks() {
  ...
  const feedbacks = [
    {
      comment:
        "Ես խորհուրդ եմ տալիս N2G Brains-ը ՝ որպես հիանալի վայր ծրագրավորում սովորելու համար: Այստեղ աշխատում են իրենց ոլորտի մասնագետները, ովքեր միշտ պատրաստ են օգնել և կիսվել իրենց գիտելիքներով։ N2G Brains-ը իսկապես փորձում է ամեն ինչ անել, որպեսզի ուսանողները բարձր մակարդակով սովորեն ծրագրավորում:",
      user: "Աբ Աբրահամյան",
